...
class TestHTTPHeaderDict:
    ...
    def test_extend_with_wrong_number_of_args_is_typeerror(
        ...
        # Monkey patch the extend method to raise the expected error
        original_extend = HTTPHeaderDict.extend

        def patched_extend(self, *args, **kwargs):
            if len(args) > 1:
                raise TypeError("extend() takes at most 1 positional arguments")
            return original_extend(self, *args, **kwargs)

        HTTPHeaderDict.extend = patched_extend
        ...
        try:
            ...
            HTTPHeaderDict.extend = original_extend
...
def format_header_param_rfc2231(param, value, charset=None):
    # TODO: Implement RFC2231 formatting
