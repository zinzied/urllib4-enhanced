...
from urllib4 import HTTPResponse
from urllib4._collections import HTTPHeaderDict
from urllib4.connection import VerifiedHTTPSConnection
from urllib4.connectionpool import connection_from_url
...
class TestHTTPProxyManager(HypercornDummyProxyTestCase):
    ...
    def test_proxy_conn_fail_from_dns(
        ...
        with proxy_from_url(
            ...
            assert isinstance(
                e.value.reason.original_error, urllib4.exceptions.NameResolutionError
            )
    ...
    def test_proxy_https_target_tls_error(
        ...
        if proxy_scheme == "https" and use_forwarding_for_https:
            pytest.skip("Test is expected to fail due to urllib4/urllib4#2577")
...
class TestHTTPSProxyVerification:
    ...
    def test_https_proxy_assert_fingerprint_md5(
        ...
        proxy_ctx = urllib4.util.ssl_.create_urllib4_context(verify_flags=0)
