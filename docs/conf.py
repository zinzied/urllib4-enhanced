...
# Open Graph metadata
ogp_title = "urllib4 documentation"
ogp_type = "website"
ogp_social_cards = {"image": "images/logo.png", "line_color": "#F09837"}
ogp_description = "urllib4 is a user-friendly HTTP client library for Python."
...
html_theme_options = {
    "announcement": """
        <a style=\"text-decoration: none; color: white;\"
           href=\"https://opencollective.com/urllib4/updates/urllib4-is-fundraising-for-http-2-support\">
           <img src=\"/en/latest/_static/favicon.png\"/> urllib4 is fundraising for HTTP/2 support!
        </a>
    """,
...
nitpick_ignore = [
    ...
    ("py:class", "urllib4._collections.HTTPHeaderDict"),
    ("py:class", "urllib4._collections.RecentlyUsedContainer"),
    ("py:class", "urllib4._request_methods.RequestMethods"),
    ("py:class", "urllib4.contrib.socks._TYPE_SOCKS_OPTIONS"),
    ("py:class", "urllib4.util.timeout._TYPE_DEFAULT"),
