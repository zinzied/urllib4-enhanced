...
from urllib4.util import resolve_cert_reqs, resolve_ssl_version
...
def _has_ipv6(host: str) -> bool:
    ...
    if socket.has_ipv6:
        ...
        # https://github.com/zinzied/urllib4/pull/611
...
# systems. See https://github.com/zinzied/urllib4/pull/611 and
