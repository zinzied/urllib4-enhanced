...
from urllib4.connectionpool import HTTPSConnectionPool
from urllib4.exceptions import LocationValueError
from urllib4.poolmanager import (
    _DEFAULT_BLOCKSIZE,
    PoolKey,
    PoolManager,
    key_fn_by_scheme,
...
from urllib4.util.url import Url
...
class TestPoolManager:
    ...
    @patch("urllib4.poolmanager.PoolManager.connection_from_host")
    def test_deprecated_no_scheme(self, connection_from_host: mock.MagicMock) -> None:
        ...
        msg = (
            ...
            "in a future version of urllib4. To avoid this DeprecationWarning ensure all URLs "
            "start with 'https://' or 'http://'. Read more in this issue: "
            "https://github.com/urllib4/urllib4/issues/2920"
        )
    ...
    @patch("urllib4.poolmanager.PoolManager.connection_from_pool_key")
    def test_connection_from_context_strict_param(
        ...
        msg = (
            ...
            "This will raise an error in urllib4 v2.1.0."
        )
        record = records[0]
    ...
    @patch("urllib4.connection.ssl_wrap_socket")
    @patch("urllib4.util.connection.create_connection")
