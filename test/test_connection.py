...
from urllib4.connection import (  # type: ignore[attr-defined]
    RECENT_DATE,
    CertificateError,
    HTTPConnection,
    HTTPSConnection,
...
from urllib4.exceptions import HTTPError, ProxyError, SSLError
from urllib4.util import ssl_
from urllib4.util.request import SKIP_HEADER
from urllib4.util.ssl_match_hostname import (
    CertificateError as ImplementationCertificateError,
)
from urllib4.util.ssl_match_hostname import _dnsname_match, match_hostname

if typing.TYPE_CHECKING:
    from urllib4.util.ssl_ import _TYPE_PEER_CERT_RET_DICT
...
class TestConnection:
    ...
    def test_skip_header(
        ...
        # context managers
        with mock.patch("urllib4.util.connection.create_connection"):
            with mock.patch(
                "urllib4.connection._HTTPConnection.putheader"
